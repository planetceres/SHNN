...
class SetTimeWaitPage(DecorateIsDisplayMixin, WaitPage):
    # Base Mixin... must be used for ALL players pages of our site!!!
    template_name = 'otree_mturk_utils/SetTimeWaitPage.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        time_delta = self.time_to_begin - datetime.now()
        time_left = time_delta.seconds
    ...
    def __init__(self):
        super(SetTimeWaitPage, self).__init__()




class CustomWaitPageTreatment(DecorateIsDisplayMixin, WaitPage):
    # Base Mixin... must be used for ALL players pages of our site!!!
    template_name = 'otree_mturk_utils/CustomWaitPageTreatment.html'
    ...
    def __init__(self):
        super(CustomWaitPageTreatment, self).__init__()
